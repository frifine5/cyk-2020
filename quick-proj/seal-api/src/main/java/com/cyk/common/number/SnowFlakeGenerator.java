...
public class SnowFlakeGenerator {
    ...
    private final static long START_STAMP = 1590738342515L;  // 2020-05-29 15:45:42
    /** 可分配的位数  */
...
//				throw new IllegalStateException("sequence over flow");
    ...
    public static void main(String[] args) {
        SnowFlakeGenerator sfg = new Factory().create(0,0);
        long id0 = sfg.nextId();
        ...
        String curTimeFormat = String.format(" %dL; // %s", cur, ParamsUtil.formatTime19(new Date(cur)));
        System.out.println(curTimeFormat);
