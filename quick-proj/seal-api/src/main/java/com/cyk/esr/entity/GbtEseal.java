...
/**
 * GMT 38540-2020 电子印章： version = 4 ; v4
 * @author WangChengyu
 * 2019/12/10 11:12
 */
public class GbtEseal {
/* // 总览结构
...
//    签名值:signData	BIT STRING
     ...
     * 电子印章结构的必要参数校验
     */
    public static boolean verifyESealNec(GbtEseal eseal){
        if(null == eseal) throw new NullPointerException("印章参数为空");
        if(4 != eseal.getVersion()) throw new IllegalArgumentException("非法版本号：" + eseal.getVersion());
        // 查空字符串
