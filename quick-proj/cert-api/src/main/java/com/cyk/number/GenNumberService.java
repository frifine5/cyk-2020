package com.cyk.number;

import com.cyk.common.number.SnowFlakeGenerator;
...
//            Collections.synchronizedMap(new HashMap<>());// 线程安全，较慢
    ...
    static{
        ...
        numSelector.put("1-1", new SnowFlakeGenerator.Factory().create(1, 1));
    }

    @Value("${number.generator.idc:1}")
    int idcId;

    @Value("${number.generator.machine:1}")
    int machineId;
